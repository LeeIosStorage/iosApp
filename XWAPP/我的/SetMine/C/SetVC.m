...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([title isEqualToString:@"关于我们"]) {
        ...
        [[UIApplication sharedApplication] openURL:[NSURL URLWithString:[NSString stringWithFormat:@"itms-apps://itunes.apple.com/app/id%@",Itunes_APPID]]];//https://itunes.apple.com/cn/app/id1404835477?mt=8
